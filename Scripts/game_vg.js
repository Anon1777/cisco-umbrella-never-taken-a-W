...
function checkMultiAnswer(n) {
    ...
    if (objQ.qText == $("#btnAnswer" + n).html().substring(3)) {
...
function setupCompletion() {
    ...
    if (($.cookie("hasAccount") == "true" || isChallenge == true) && reviewMode == 0 && window.location.href.indexOf("shownext=1") == -1) {
...
function saveHighScore() {
    ...
    if (customID == '') {
        saveScore(gameID, customID, $.cookie("memberName"), $.cookie("memberId"), score, start, end, gameDuration, correctClicks, totalClicks - correctClicks, gMode, gameDuration2.toString(), lang, $.cookie("sessionId"), $("#nickname").val())
        displayTop10()
